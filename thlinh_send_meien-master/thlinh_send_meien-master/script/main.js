// Function to fetch and apply data
const fetchData = () => {
      ...
      dataArr.forEach(customData => {
        if (data[customData] !== "") {
          ...
          if (element) {
            ...
            console.warn(`Element with data-node-name="${customData}" not found.`);
          }
        }
      });

      // Start background music and animation after data is processed
      playBackgroundMusic();
      animationTimeline();
    })
